...
#     nova_enota = "Celzija"
#     print(f"Temperatura v stopinjah {nova_enota} je {odg} stopinj.")
# 
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDQ1NywidXNlciI6OTc4NH0:1t9TCH:dzf4SgURhz6ugDbaaw6MctaXjgUZBSk8KJ3fE-WE868"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDQ1OCwidXNlciI6OTc4NH0:1t9TCH:zCdbqIDskyN1W4sIRrU5g2FkFmctS8qtDno6dAxURmM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDQ1OSwidXNlciI6OTc4NH0:1t9TCH:3k2CmVIQYh5EGl26xf5_3fR1cTsgfmrn9-Sc3O2FBo4"
        try:
            Check.equal("fizzbuzz(18)", 'fizz') and \
            Check.equal("fizzbuzz(20)", 'buzz') and \
            Check.equal("fizzbuzz(30)", 'fizzbuzz') and \
