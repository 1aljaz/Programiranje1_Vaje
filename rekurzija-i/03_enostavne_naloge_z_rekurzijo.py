...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDcyMCwidXNlciI6OTc4NH0:1u4Ztm:-iF4A_nkB2epU53s53AkE-2T7oA4s51p84nVXfnHTzQ"
        try:
            sol = Check.current_part['solution']
            if 'while ' in sol or 'for ' in sol:
                Check.error('Rekli smo brez zank!')
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDcyMSwidXNlciI6OTc4NH0:1u4Ztm:mRHKsEMApqdlbbacqp_qnInlMdEqr1utPpr59d98Ob0"
        try:
            sol = Check.current_part['solution']
            if 'while ' in sol or 'for ' in sol:
                Check.error('Rekli smo brez zank!')
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDcyMiwidXNlciI6OTc4NH0:1u4Ztm:4VaUxbTy-soYZStAfAB5CtEveM4nXavf2Q_VAKKHqtE"
        try:
            sol = Check.current_part['solution']
            if 'while ' in sol or 'for ' in sol:
                Check.error('Rekli smo brez zank!')
