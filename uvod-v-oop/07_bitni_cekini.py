...
# 
# To pomeni, da se v razred "skopirajo" vse definicije, ki ste jih v razred
# BitniCekin napisali prej.
# Seveda pa 1. podnalogo še vedno začnemo z 
# 
#                   class BitniCekin:
# 
# Druga možnost je, da podnaloge vedno začnemo z 
# 
#                   class BitniCekin:
# 
# a potem moramo v razred vedno napisati (skopirati) vse metode, ki smo jih
# definirali v vseh prejšnjih podnalogah [pri tej nalogi je
# v uradnih rešitvah uporabljena prav ta možnost].
# =====================================================================@040871=
# 1. podnaloga
# Sestavite razred `BitniCekin` s konstruktorjem `__init__(self, stanje)`,
# ki sprejme začetno stanje na računu (v valuti Bitcoin).
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDg3MSwidXNlciI6OTc4NH0:1uJnlQ:DKrupFeQ37dAzEyVfy0KZVLKv2BRHk-MSW4cXLSXPJ8"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDg3MiwidXNlciI6OTc4NH0:1uJnlQ:tHfuHioCkmdmgB0ymnFR7rR3ObAS1vZM4az-O-W5BMc"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDg3MywidXNlciI6OTc4NH0:1uJnlQ:QYl40oof7MNLwwo_0HGuE_EjvnW-LksHYdsoK1I9r4Y"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDg3NCwidXNlciI6OTc4NH0:1uJnlQ:EoDSLhn-c52JgQKBJgWFhSMNWa1HCNIpHucjlzIgm7s"
        try:
