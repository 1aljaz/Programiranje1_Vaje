...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDY5NywidXNlciI6OTc4NH0:1u2rn9:NiC7mAMqFiVcF2u-S3pA6GMViwcphfZmwLTm0TebNj8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDY5OCwidXNlciI6OTc4NH0:1u2rn9:mo336fKBDY3V_9043XLROJuI5oXElKoz7aqt4YRFmhE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDY5OSwidXNlciI6OTc4NH0:1u2rn9:XviozLYG4GMFgoTgfvL8rrIVykREKi2-GGlr9g5I02Q"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDcwMCwidXNlciI6OTc4NH0:1u2rn9:ecSNHwwVCzryp-6SbnytxN6I4wMyFGjt2oj-IsjhMVk"
        try:
            test_data = [
                ({'ime': 'Žak', 'priimek': 'Koc'},
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDcwMSwidXNlciI6OTc4NH0:1u2rn9:q8TcYVaezsZnsyPpnDaP2FIq_Xre5myAM3gldm7e5AQ"
        try:
            test_data = [
                ([{'ime': 'Jan', 'priimek': 'Dan', 'naslov': 'Jadranska 21'},
                  {'ime': 'Jan', 'priimek': 'Dan', 'naslov': 'Jadranska 19'},
