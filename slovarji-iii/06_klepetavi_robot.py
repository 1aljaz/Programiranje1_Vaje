...
# število besed, ki jih želimo generirati. 
# 
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MjkxOSwidXNlciI6OTc4NH0:1u2rn9:vHKWSBO00iJOQn4asC2FiMh0J97sE2hjJRJeh9Kwi_M"
        try:
            testi = [
                (
                    "in in in in", 
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MjkyMCwidXNlciI6OTc4NH0:1u2rn9:cRRU0eCHaZGrH7G98S4bCNXEUGTwCZhJxr6TLALWx5A"
        try:
            import itertools
            import random
            random.seed(2025)
