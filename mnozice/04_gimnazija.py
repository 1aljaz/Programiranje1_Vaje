...
def _validate_current_file():
    ...
    if Check.part():
        ...
        try:
            ...
            Check.equal('vrni_tri(2, 2)', ({30}, set(), {5})) and \
            Check.equal('vrni_tri(10, 10)', ({270, 240, 210, 180, 150, 120, 90, 60, 30}, {1}, {5, 10, 15, 20}))
        except TimeoutError:
    ...
    if Check.part():
        ...
        try:
            ...
            Check.equal('racuni({1, 2, 3}, {1, 2, 3}, {1, 2, 3})', ({1, 2, 3}, set(), {1, 2, 3})) and \
            Check.equal('racuni({1, 2, 3}, {2, 3}, {1, 2})', ({2}, set(), {1, 2}))
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
            Check.error(
    ...
    if Check.part():
        ...
        try:
            ...
            Check.equal('kartezicni(set(), {3, 1})', (set(), {(3, 3), (3, 1), (1, 3), (1, 1)}))
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
            Check.error(
