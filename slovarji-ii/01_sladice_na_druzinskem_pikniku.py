...
#     ['mami', 'ati']
# =============================================================================
def druzinski_clani(sl):
    """Vrne druzinski clani v slovarju sl"""
    return [oseba for oseba, _ in sl.items()]
# =====================================================================@040687=
# 2. podnaloga
...
# =============================================================================
def zdruzi_sladkosnede(sl1, sl2):
    """Zdruzi dva slovarja"""
    for oseba, stvar in sl2.items():
        if oseba not in sl1:
            sl1[oseba] = stvar
    return sl1
# =====================================================================@040688=
...
#     {'pita': 1}
# =============================================================================
def nakupovalni_seznam(sl, povaljeni):
    """Vrne katere stvari moramo kupovati."""
    rez = {}
    for oseba, stvar in sl.items():
        if oseba in povaljeni:
            rez[stvar] = rez.get(stvar, 0) + 1
    return rez
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDY4NiwidXNlciI6OTc4NH0:1tzVFv:iiU9DaXKxePwkI6hxsIqfD1Q8HdJgM9eOBMVxzy_4eg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDY4NywidXNlciI6OTc4NH0:1tzVFv:t6NKUat585O1YOJNSbPyNFBLfGEMX-3870xJNkCK-rA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDY4OCwidXNlciI6OTc4NH0:1tzVFv:_oQvKFhrsX2emEOCzuS2t5ssOtH9EiJXQUzawIX2Yxo"
        try:
