...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDU2MSwidXNlciI6OTc4NH0:1tV8mJ:ClRHZxZ4YO_BlNa86KO31aCt7yQNGP0YaTs01X6WKos"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDU2MiwidXNlciI6OTc4NH0:1tV8mJ:yTgBY0nBPR3e72sEJQPbFAsiGxAsOJ-k560M7zlPdvc"
        try:
            res = Check.current_part["solution"]
            sw = re.sub('[ \n]', '', res)
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDU2MywidXNlciI6OTc4NH0:1tV8mJ:PInYQYWrhuXemviz8xNh-ZIQqzdQYH_iu88-mp_AFck"
        try:
            res = Check.current_part["solution"]
            sw = re.sub('[ \n]', '', res)
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDU2NCwidXNlciI6OTc4NH0:1tV8mJ:eF1RG_zRkm2A1u43oHnvf4P3W0mmd0YUNyJWcml8GrI"
        try:
            res = Check.current_part["solution"]
            sw = re.sub('[ \n]', '', res)
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDU2NSwidXNlciI6OTc4NH0:1tV8mJ:sngaJXgjLAanzUqGw42762h_yJJRHea-NiwBNQz82cQ"
        try:
            sw = re.sub('[ \n]', '', res)
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDU2NiwidXNlciI6OTc4NH0:1tV8mJ:Ha5Cy6nR88HFy34ijZk59kWsO-410IOCr4s9IChj0vg"
        try:
            sw = re.sub('[ \n]', '', res)
