...
# =====================================================================@040816=
# 1. podnaloga
# Direktor podjetja je dobil dopis, v katerem je pisalo:
...
#     znanja na svojem podrocju. Moje mnenje je, da ga lahko takoj
...
#     Prosim znova preberite vsako drugo vrstico prejšnega dopisa.
# 
# Direktor je sedaj povsem zmeden. Pomagaj mu in sestavi funkcijo
# `izpisi_drugo(vhodna, izhodna)`, ki na `izhodna` izpiše vsako drugo vrstico
# vsebine datoteke `vhodna`!
# =============================================================================
def izpisi_drugo(vhodna, izhodna):
    flip = True
    with open(izhodna, 'w') as w:
        with open(vhodna, 'r') as r:
            for l in r:
                if flip:
                    w.write(l)
                flip = not flip
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDgxNiwidXNlciI6OTc4NH0:1uCBf0:QZLKlUE5heK1le4zzPKB1cCBR9ZovNshAQSd2j07b8Y"
        try:
