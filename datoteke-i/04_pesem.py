...
# funkcijo `odstrani_prazne_vrstice(vhodna, izhodna)`, ki bo 
# za dano ime datoteke `vhodna` vse kitice združila in jih izpisala na
# datoteko `izhodna`.
# <h5>vhodna:</h5>
# 
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDgxNSwidXNlciI6OTc4NH0:1uCBf0:xmfjwJeZWrDC8K0YObb0FvfredxS2TTSP22j3sKU2Ss"
        try:
