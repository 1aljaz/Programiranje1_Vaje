...
def prestej_vrstice(datoteka):
    return len(open(datoteka, 'r').readlines())
# =====================================================================@040814=
# 2. podnaloga
...
# Če datoteka ne vsebuje dovolj vrstic, naj vrne prazen niz.
# =============================================================================
def vrni_k_vrstico(datoteka, k):
    if prestej_vrstice(datoteka) >= k-1:
        return open(datoteka, 'r').readlines()[k-1]
    return ""
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDgxMywidXNlciI6OTc4NH0:1uCBf0:g1UnnNrsV3J3Ki2UVAKS4ajXjM8k43OFhzpjWHmF5cE"
        try:
            ...
            with Check.in_file("pri.dat",[
            "1"
            ]):
                Check.equal('prestej_vrstice("pri.dat")', 1)
                
            with Check.in_file("a.dat",[
            "1",
            "",
            "3",
            "",
            ...
            "4"
                ...
                Check.equal('prestej_vrstice("a.dat")', 6)
        except TimeoutError:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDgxNCwidXNlciI6OTc4NH0:1uCBf0:JojyAPi9mUQeSzxR7FiB0qdYIud_smfdYTD6iu2uQpE"
        try:
