...
def koliko_potomcev(ime, rodovnik):
    if ime not in rodovnik or koliko_otrok(ime, rodovnik) == 0:
        return 0
    
    return sum(koliko_otrok(s, rodovnik) for s in rodovnik[ime])
# =====================================================================@040745=
# 3. podnaloga
# Število oseb
# 
# Sestavi funkcijo `koliko_oseb(rodovnik)`, ki za dan
# `rodovnik` vrne število oseb v tem rodovniku.
# =============================================================================
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDc0MywidXNlciI6OTc4NH0:1u77I1:yRGdAgySOd_iLbSMFo1PwJctVA26jOE8aCY85YY6nF8"
        try:
            rodovnikCG = {
             'Ulrik I.': ['Viljem'], 'Margareta': [], 'Herman I.': ['Herman II.', 'Hans'],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDc0NCwidXNlciI6OTc4NH0:1u77I1:MphpE8oKWmZFvxoshfI6xRJR1yN3MT2zCax3tSrIutg"
        try:
            rodovnikCG = {
             'Ulrik I.': ['Viljem'], 'Margareta': [], 'Herman I.': ['Herman II.', 'Hans'],
             'Elizabeta II.': [], 'Viljem': ['Ana Celjska'], 'Elizabeta I.': [],
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDc0NSwidXNlciI6OTc4NH0:1u77I1:xzpCNioTaryPNn3vPD7B_yORO5296i4_9BhtRsuwKJg"
        try:
            rodovnikCG = {
             'Ulrik I.': ['Viljem'], 'Margareta': [], 'Herman I.': ['Herman II.', 'Hans'],
             'Elizabeta II.': [], 'Viljem': ['Ana Celjska'], 'Elizabeta I.': [],
            ...
            tests = [
                    ("koliko_oseb(rodovnikCG)", 20, {'rodovnikCG': rodovnikCG}),
                    ("koliko_oseb(dict())", 0, {'rodovnikCG': rodovnikCG}),
                    ("koliko_oseb(druzina2)", 5, {'druzina2': druzina2}),
                    ("koliko_oseb(druzina1)", 4, {'druzina1': druzina1}),
                    ("koliko_oseb(druzina3)", 6, {'druzina3': druzina3}),
                    ("koliko_oseb(druzina4)", 11, {'druzina4': druzina4})
                    ]
