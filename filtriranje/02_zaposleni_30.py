...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg2OCwidXNlciI6OTc4NH0:1tuRRO:Z-X4Mjf0Zsd-P4HoezjRuZ6geGW_lWjxUM2YaJDrUFg"
        try:
            testi_ok = True
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg2OSwidXNlciI6OTc4NH0:1tuRRO:gmYQxbNV_pNcOaNQ4MSxjHnNeRruF2w09C31sM5_Sxk"
        try:
            nadaljuj = testi_ok
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg3MCwidXNlciI6OTc4NH0:1tuRRO:oLU-pqN0QY0ZfzaCXjbAvzPVgwHRhlM6FO4-rwV3Fak"
        try:
            nadaljuj = testi_ok
