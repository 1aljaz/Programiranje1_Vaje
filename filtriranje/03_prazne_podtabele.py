...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg3MSwidXNlciI6OTc4NH0:1tuRRO:rnaUwbnVLXJhOi2yAa-CXx_H7osDGu5kguPr3czX6S0"
        try:
            testi_ok = True
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg3MiwidXNlciI6OTc4NH0:1tuRRO:aprwtwa1VcbrfXtaM0ONaOP6HB6IAX1YwukggvoWkaM"
        try:
            nadaljuj = testi_ok
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg3MywidXNlciI6OTc4NH0:1tuRRO:Panm3L3lynB4rhUouOX9JwBsjcuuhrkJiBMI8FHzZMw"
        try:
            nadaljuj = testi_ok
