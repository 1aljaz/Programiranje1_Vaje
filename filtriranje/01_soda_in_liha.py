...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg2NSwidXNlciI6OTc4NH0:1tuRRO:udorVOSo0LCWmuNR0Zv3PzDq6sUhDKJkLP4yhRVZubw"
        try:
            testi_ok = True
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg2NiwidXNlciI6OTc4NH0:1tuRRO:KOhVspUPIxXafoxnZRBtWsazg7kMUeK-9P0_z-aOlD0"
        try:
            nadaljuj = testi_ok
            if not testi_ok:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg2NywidXNlciI6OTc4NH0:1tuRRO:KAlAy1OLncdLj-ZITzhOKPOpCuFUBzhMPY0ICAvx6sY"
        try:
            nadaljuj = testi_ok
