...
# Sestaviti želimo funkcijo, ki vrne tabelo imen in priimkov nagrajencev. 
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg4OSwidXNlciI6OTc4NH0:1tuRRO:u7Qnv7PY9RFlgAlwzre_BKBn8fHv-VHlenIBEJWS4kE"
        try:
            testi_ok = True
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg5MCwidXNlciI6OTc4NH0:1tuRRO:i6wDDyqFGLHTcAVTEAT8mITtwUqUpQbGxmZc8MNZ6Vo"
        try:
            nadaljuj = testi_ok
            if not testi_ok:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0Mjg5MSwidXNlciI6OTc4NH0:1tuRRO:73-hlQiYOEXOZiLLbH4sav9ac_c5mJC7qmoPe0uYG8k"
        try:
            nadaljuj = testi_ok
