...
def imamo_sestavine(recept, shramba):
    """Vrne True ce imamo vse stvari v shrambi, drugace False."""
    for key, value in recept.items():
        if key not in shramba:
            return False
        if recept[key] > shramba[key]:
            return False
    return True
# =====================================================================@040673=
# 3. podnaloga
...
#     {'jajca': 3, 'moka': 50}
# =============================================================================
def potrebno_kupiti(recept, shrambra):
    """Vrne kaj je potrebno kupiti"""
    zravn = {}
    for key, value in recept.items():
        if key not in shrambra:
            zravn[key] = value
        elif value > shrambra[key]:
            zravn[key] = value - shrambra[key]
    return zravn
...
def _validate_current_file():
    ...
    if Check.part():
        ...
        try:
            ...
            # v navodilih posebej opozoriti, da se stari recept NE sme spremeniti
            Check.equal("pomnozi({'moka': 300, 'sladkor': 120, 'maslo': 100, 'rumenjak': 2, 'jabolka': 5}, 2)",
                        {'moka': 600, 'sladkor': 240, 'maslo': 200, 'rumenjak': 4, 'jabolka': 10}) and \
            Check.equal("pomnozi({'moka': 100, 'jajca': 2, 'mleko': 300}, 3)",
                        {'moka': 300, 'jajca': 6, 'mleko': 900}) and \
            Check.equal("pomnozi({i : i + 2 for i in range(0, 100)}, 5.5)",
                        {i: (i + 2)*5.5 for i in range(0, 100)})
        except TimeoutError:
    ...
    if Check.part():
        ...
        try:
            ...
            Check.equal("imamo_sestavine({'jajca': 3, 'moka': 500}, {'moka': 1000, 'sladkor': 1000, 'jajca': 2})",
                        False) and \
            Check.equal("imamo_sestavine({'jajca': 3, 'moka': 500}, {})", False) and \
            Check.equal("imamo_sestavine({'jajca': 3, 'moka': 500}, {'moka': 1000, 'sladkor': 1000, 'jajca': 3})",
                        True) and \
            Check.equal("imamo_sestavine({}, {'moka': 1000, 'sladkor': 1000, 'jajca': 3})",
                        True)
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
    ...
    if Check.part():
        ...
        try:
            Check.equal("potrebno_kupiti({'jajca': 3, 'moka': 500}, {'moka': 450, 'sladkor': 1000})",
                        {'jajca': 3, 'moka': 50}) and \
            Check.equal("potrebno_kupiti({'jajca': 3, 'moka': 500}, {'moka': 1000, 'sladkor': 1000})",
                        {'jajca': 3}) and \
            Check.equal("potrebno_kupiti({'jajca': 3, 'moka': 500, 'sladkor': 0}, {'moka': 1000, 'sladkor': 1000})",
                        {'jajca': 3}) and \
            Check.equal("potrebno_kupiti({'jajca': 3, 'moka': 500}, {})",
                        {'jajca': 3, 'moka': 500}) and \
            Check.equal("potrebno_kupiti({'jajca': 3, 'moka': 500}, {'moka': 1000, 'sladkor': 1000, 'jajca': 3})",
                        dict())
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
