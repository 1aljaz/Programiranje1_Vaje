...
# v šoli 
# in vrne _množico_ tistih, ki so ljubljeni. Zgled (če je slovar `sola`
# enak kot zgoraj):
# 
#     >>> ljubljeni(sola)
#     {'Bine', 'Davorka', 'Cene'}
...
def _validate_current_file():
    ...
    if Check.part():
        ...
        try:
            ...
            Check.equal("narcisoidi({0})".format(sola), {'Davorka'}) and \
            Check.equal("narcisoidi({})", set()) and \
            Check.equal("narcisoidi({'Ana':{'Ana','Bine'}})", {'Ana'}) and \
            Check.equal("narcisoidi({'Bana':{'Ana','Bana'}, 'Ana': {'Bana'}})", {'Bana'})
        except TimeoutError:
    ...
    if Check.part():
        ...
        try:
            ...
            Check.equal("ljubljeni({'Bana':{'Ana','Bana'}, 'Ana': {'Bana'}})", {'Ana','Bana'})
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
            Check.error(
    ...
    if Check.part():
        ...
        try:
            ...
            Check.equal("zaljubljeni_v_osebo('Cene', {'Ana' : {'Bine', 'Cene'},"
                                                       ...
                                                       "'Davorka' : {'Davorka'},"
                                                       "'Eva' : {'Bine'}})", {'Ana'}) and \
            Check.equal("zaljubljeni_v_osebo('Bana', {'Bana':{'Ana','Bana'}, 'Ana': {'Bana'}})", {'Bana', 'Ana'})
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
            Check.error(
